...
define('APP_BASE_URL', 'http://minhati.ddns.net:8088/i3flex/');
...
*/
define('APP_ENC_KEY', '7c30eab86fefdff7be6fa00b5dd82ffa');

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', 'db-mysql-nyc3-22678-do-user-12312820-0.b.db.ondigitalocean.com:25060');
/**
 ...
 */
define('APP_DB_PASSWORD', 'AVNS_6yi05ZnRhtCud4GN1hk');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'i3flex');
