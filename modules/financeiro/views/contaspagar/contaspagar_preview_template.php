...
<?php } ?>
<?php if (count($faturas_a_juntar) > 0) { ?>
    ...
    [
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="tab_reminders">
                    ...
                    <?php $this->load->view('admin/includes/modals/reminder', ['id' => $invoice->id, 'name' => 'invoice', 'members' => $membros, 'reminder_title' => _l('invoice_set_reminder_title')]); ?>
                </div>
                <?php if (count($invoice_recurring_invoices) > 0 || $invoice->recurring != 0) { ?>
