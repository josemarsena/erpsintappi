...
<div class="ps-view tw-mt-8" id="companies" style="display:none;">
    <div class="<?= empty($companies) ? 'tw-w-full' : 'tw-grid tw-gap-3 tw-grid-cols-1 sm:tw-grid-cols-2 md:tw-grid-cols-3'; ?>">
        ...
        ?>
            <div class="company <?= $company->status; ?> panel_s tw-p-4 tw-py-2  tw-bg-neutral-150 hover:tw-bg-neutral-200 tw-flex tw-flex-col tw-justify-between tw-relative <?= $autolaunch; ?>">
                <!--- Menu -->
