...
$company = $tenant;
$deploying = $company->status === "pending";
?>
...
<div class="single-theme">
    ...
    <div class="ps-view tw-mt-8" id="companies">
        ...
        <div class="row tw-flex tw-justify-center tw-flex-wrap  company <?= $company->status; ?>">
            <div class="col-sm-12 col-md-7 company-info">
                        ...
                        <div class="menu">
                            <?php if ($company->status == 'active') : ?>
                                ...
                                <?php if ($can_preview && !$deploying) : ?>
                                    <button data-toggle="tooltip" data-title="<?= _l('perfex_saas_quick_view'); ?>" class="btn btn-primary tw-rounded-full view-company" data-slug="<?= $company->slug; ?>">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                <?php endif; ?>
                            <?php endif; ?>
            ...
            <div class="col-sm-12 col-md-5 text-center">
                ...
                ?>
                <a class="btn btn-primary" href="<?= site_url('clients/?subscription'); ?>"><?= _l('perfex_saas_change_plan'); ?></a>
            </div>
        </div>
    </div>
        ...
        <div class="iframe-wrapper tw-m-0 tw-bg-white" id="view-company-modal" style="display: none;">
            <div class="iframe-toolbar">
                <div class="tw-flex" id="company-switch">
                    <button type="button" class="btn btn-danger close-btn" data-toggle="tooltip" data-title="<?= _l('perfex_saas_back_to_client_portal'); ?>" aria-label="Close" data-placement="right">
            ...
            <iframe class="tw-w-full tw-h-full" id="company-viewer" src="<?= base_url('clients/ps_magic/' . $tenant->slug); ?>">
            </iframe>
        </div>
    <?php endif ?>
</div>

<link rel="stylesheet" type="text/css" href="<?= module_dir_url(PERFEX_SAAS_MODULE_NAME, 'assets/css/single-theme.css'); ?>" />
