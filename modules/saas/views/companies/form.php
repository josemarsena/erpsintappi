                ...
                <div class="panel_s invoice accounting-template">
                    <div class="panel-body">
                        ...
                        <div class="tw-mt-8 tw-mb-8">
                            ...
                            <?= render_select('metadata[admin_disabled_default_modules][]', $default_modules, ['system_name', ['custom_name']], $label, $selected, ['multiple' => 'true']); ?>
                        </div>
                            ...
                            <div class="form-group tw-mt-8 tw-mb-8 db_pools <?= in_array($value, ['shard', 'single_pool']) ? '' : 'hidden'; ?>">
                                <div class="tw-flex tw-items-start tw-mt-4 tw-justify-center">
                                    <div class="tw-flex tw-space-x-2 pool-template tw-items-center">
                                        <?php echo render_input('db_pools[host]', 'perfex_saas_db_host', '', 'text', ['placeholder' => 'localhost']); ?>
                                        <?php echo render_input('db_pools[user]', 'perfex_saas_db_user', '', 'text', ['placeholder' => 'root']); ?>
                                        <?php echo render_input('db_pools[password]', 'perfex_saas_db_password', '', 'text', ['placeholder' => 'password']); ?>
                                        <?php echo render_input('db_pools[dbname]', 'perfex_saas_db_name', ''); ?>
                                        <div>
                                            <button class="btn btn-info test_db_row tw-mt-2" type="button">
                                                <?= _l('perfex_saas_test'); ?>
                                            </button>
                                        </div>
                                    </div>
