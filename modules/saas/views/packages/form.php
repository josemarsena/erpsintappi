...
<?php init_head(); ?>
<?php $currency = $this->currencies_model->get_base_currency(); ?>
<?php $cycle_period = _l('perfex_saas_billing_cycle'); ?>
    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (!perfex_saas_is_single_package_mode()) : ?>
                <h4
                ...
                <div class="row">
                        ...
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <div class="tw-mt-8 tw-mb-8  tw-pt-3">
                                    ...
                                    <div class="form-group select-placeholder">
                                        ...
                                        <select class="selectpicker" data-width="100%"
                                            ...
                                            data-none-selected-text="<?= _l('perfex_saas_dropdown_non_selected_tex'); ?>"
                                            required>
                                            <?php for ($i = 0; $i <= 12; $i++) : ?>
                                            <?php
                                ...
                                <div class="tw-mt-8 tw-mb-8">
                                    ...
                                    <?= render_select('metadata[disabled_default_modules][]', $default_modules, ['system_name', ['custom_name']], $label, $selected, ['multiple' => 'true']); ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row form-group tw-flex tw-items-center tw-mb-2"
                                    ...
                                    <div class="col-md-3 input-group" data-toggle="tooltip"
                                        ...
                                        <input type="number" step="0.1" min="1" class="form-control tw-p-1"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row" id="package-qouta">
                                    ...
                                    <div class="col-md-6 col-xs-12 tw-mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" data-toggle="tooltip"
                                                ...
                                                <input type="number" value="<?= $value_unit_price; ?>" step="0.1"
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        <?php
                                        $value = (isset($package->metadata->storage_limit->size) ? $package->metadata->storage_limit->size : 5);
                                    ...
                                    <div class="col-md-6 mtop10">
                                        ...
                                        <div class="onoffswitch">
                                            <input type="checkbox" id="enable_subdomain" data-perm-id="ps1"
                                                class="onoffswitch-checkbox" <?= $checked ? 'checked' : ''; ?> value="1"
                                                name="metadata[enable_subdomain]">
                                    ...
                                    <div class="col-md-6 mtop10">
                                        ...
                                        <div class="onoffswitch">
                                            <input type="checkbox" id="enable_custom_domain" data-perm-id="ps2"
                                                class="onoffswitch-checkbox" <?= $checked ? 'checked' : ''; ?> value="1"
                                                name="metadata[enable_custom_domain]">
                                    ...
                                    <div class="col-md-6 mtop10">
                                        ...
                                        <div class="onoffswitch">
                                            <input type="checkbox" id="autoapprove_custom_domain" data-perm-id="ps3"
                                                class="onoffswitch-checkbox" <?= $checked ? 'checked' : ''; ?> value="1"
                                                name="metadata[autoapprove_custom_domain]">
                    ...
                    <!-- Discounts -->
                    <div class="col-lg-<?= perfex_saas_is_single_package_mode() ? '7' : '5'; ?>" id="discounts">
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <div class="mtop15"></div>
                                <div class="row form-group tw-flex tw-mb-2" data-repeat-list="#discount-list">
                                    <div class="col-md-4" data-toggle="tooltip"
                                        data-title="<?= _l('perfex_saas_select_an_option'); ?>">
