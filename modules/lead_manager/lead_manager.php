...
Description: Sfrutta al massimo ogni opportunità con un sistema che centralizza tutte le informazioni sui tuoi contatti, rendendole facilmente accessibili per strategie di marketing mirate.
Version: 1.0.6
Requires at least: 2.3.*
Author: Creativec
Author URI: https://creativecommunications.it
Author Email: info@creativecommunications
Copyright: (c) 2024, Vincenzo Canò
Developer: Vincenzo Canò
Developer URI: https://www.creativecommunications.it
*/

if (!defined('MODULE_LEAD_MANAGER')) {
	define('MODULE_LEAD_MANAGER', basename(__DIR__));
}
update_option('lead_manager_verification_id', '11');
update_option('lead_manager_verified', true);
update_option('lead_manager_last_verification', time());
$CI = &get_instance();
