...
/*
Module Name: Registros RH
Description: A principal função dos Registros de RH é fornecer um banco de dados central contendo registros de todos os funcionários anteriores e atuais
Version: 1.0.1
...
function hr_profile_load_js(){    
	...
	function hr_profile_permissions()
	{
		...
		//Onboarding Process
		register_staff_capabilities('hrm_reception_staff', $capabilities, _l('HR_reception_staff'));
		//Hr Profile
		register_staff_capabilities('hrm_hr_records', $capabilities, _l('hr_hr_records'));
		//Job Description
		register_staff_capabilities('staffmanage_job_position', $capabilities_2, _l('HR_job_escription'));
		//Training
		...
		//Contracts
		register_staff_capabilities('hrm_contract', $capabilities, _l('HR_contract'));
		//Dependent Persons
		register_staff_capabilities('hrm_dependent_person', $capabilities, _l('HR_dependent_persons'));
		//Resignation procedures
		register_staff_capabilities('hrm_procedures_for_quitting_work', $capabilities, _l('HR_resignation_procedures'));
		//Reports
