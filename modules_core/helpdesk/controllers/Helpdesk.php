...
class Helpdesk extends AdminController
{
     ...
     * @param $userid
     * @return void
     * Description: Adiciona um novo Ticket de Suporte
     */
    public function adicionar($userid = false)
    {
        if ($this->input->post()) {
    ...
    {
        if (!$id) {
            redirect(admin_url('helpdesk/ticket/adicionar'));
        }
        ...
        add_admin_tickets_js_assets();
        $this->load->view('helpdesk/tickets/single', $data);
    }
