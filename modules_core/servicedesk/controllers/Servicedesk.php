...
class Servicedesk extends AdminController
{
    ...
    {
        $this->list_ordemservico($id);
    }

    /* List all tasks */
    public function list_ordemservico($id = '')
    {
        close_setup_menu();
        $data['statuses'] = $this->projects_model->get_project_statuses();
        $data['title']    = 'Ordens de Serviço';
        $data['table'] = App_table::find('ordemservico');
        $this->load->view('servicedesk/os/gerenciar', $data);
    }
    ...
    {
        echo $this->load->view('servicedesk/os/kan_ban', [], true);
    }
